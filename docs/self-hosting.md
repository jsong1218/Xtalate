...
there is no size limit when you run it yourself. There is also a **hosted demo** on Hugging Face
Spaces — ephemeral, anonymous, 25 MB cap — a quick way to try the UI without running anything; see
[`docs/huggingface-space.md`](huggingface-space.md).
